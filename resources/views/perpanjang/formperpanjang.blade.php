...
@section('content')
    <div class="container-form-biodata">
        <div class="text-start p-3">
            <a>Perpanjangan Akun Mitra Penyewaan Aset</a>
        </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="foto_ktp" name="foto_ktp" class="form-control"
                                        accept=".jpg,.jpeg,.pdf" value="340413140998788001">
                                    <div class="form-text">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="harga_sewa" name="harga_sewa" class="form-control"
                                                placeholder="Rp."
                                                value="Rp.{{ number_format($dataps->harga_sewa ?? 0, 0, ',', '.') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="total_harga" name="total_harga" class="form-control"
                                                placeholder="-"
                                                value="Rp.{{ number_format($dataps->total_harga ?? 0, 0, ',', '.') }}">
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="{{ asset('asset/js/perpanjang.js') }}"></script>

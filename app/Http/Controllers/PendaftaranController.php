...
class PendaftaranController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'no_akte_pendirian' => 'nullable|string|max:50', // diubah jadi nullable
            'no_anggaran_dasar' => 'nullable|string|max:50', // diubah jadi nullable
            'tanggal_anggaran_dasar' => 'nullable|date', // diubah jadi nullable
            'no_kemenkumham' => 'nullable|string|max:50', // diubah jadi nullable
            'tanggal_kemenkumham' => 'nullable|date', // diubah jadi nullable
            'no_penetapan_pengadilan' => 'nullable|string|max:50',
            'tanggal_penetapan_pengadilan' => 'nullable|date',
            'no_izin_berusaha' => 'nullable|string|max:50', // diubah jadi nullable
            'tanggal_izin_berusaha' => 'nullable|date', // diubah jadi nullable
            'surat_keterangan_pajak' => 'nullable|string|max:50', // diubah jadi nullable
            'tanggal_surat_keterangan_pajak' => 'nullable|date', // diubah jadi nullable
            'surat_pengukuhan_pkp' => 'nullable|string|max:50', // diubah jadi nullable
            'tanggal_surat_pengukuhan_pkp' => 'nullable|date', // diubah jadi nullable
            // Data Aset - Step 2

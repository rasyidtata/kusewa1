...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.formatCurrency = (angka) => CurrencyCalculator.formatDisplay(angka);
    window.convertCurrency = (rupiahString) => CurrencyCalculator.convertToNumber(rupiahString);
    window.calculateAll = () => CurrencyCalculator.calculateAll();
    // Inisialisasi
    document.addEventListener('DOMContentLoaded', function() {
